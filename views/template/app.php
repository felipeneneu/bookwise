...
<body class="text-slate-400 ">
 ...
 hover:opacity-65">Explorar</a></li>
  ...
  <footer class="footer bg-base-200 text-base-content p-10">
    <div class="mx-auto max-w-screen-lg grid grid-cols-[200px_minmax(200px,_1fr)_100px] ">
  ...
  <footer class="footer bg-base-200 text-base-content border-base-300 border-t">
    <div class="py-4 mx-auto max-w-screen-lg px-4 footer">
